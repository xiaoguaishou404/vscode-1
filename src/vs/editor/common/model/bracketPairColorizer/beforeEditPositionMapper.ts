...
export class BeforeEditPositionMapper {
	...
	private readonly edits: readonly TextEditInfo[];
	...
	*/
	constructor(
		...
		this.edits = edits.map(edit => TextEditInfo.from(edit));
	}
...
class TextEditInfo {
	static from(edit: TextEdit): TextEditInfo {
		return new TextEditInfo(edit.startOffset, edit.endOffset, edit.newLength);
	}
