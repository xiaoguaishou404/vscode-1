		...
		//#region create browser window
		{
			...
			const options: BrowserWindowConstructorOptions = {
				...
				webPreferences: {
					...
					additionalArguments: [`--vscode-window-config=${this.configObjectUrl.resource.toString()}`, '--context-isolation' /* TODO@bpasero: Use process.contextIsolateed when 13-x-y is adopted (https://github.com/electron/electron/pull/28030) */],
